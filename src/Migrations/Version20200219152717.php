 ...
 */
final class Version20200219152717 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE proposal (id INT NOT NULL, user_id_id INT NOT NULL, title VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, text_content TEXT DEFAULT NULL, link VARCHAR(255) DEFAULT NULL, is_published BOOLEAN NOT NULL, date_publication_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_BFE594729D86650F ON proposal (user_id_id)');
        $this->addSql('CREATE TABLE review (id INT NOT NULL, proposal_id_id INT NOT NULL, user_id_id INT NOT NULL, is_approved BOOLEAN NOT NULL, decision_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE social_network (id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
